            ...
            {aleaciones.map((item, index) => (
              ...
              >
                ...
                <div className="relative p-7">
                  ...
                  <button
                    onClick={irACotizar}
                    className="w-full py-3 rounded-xl border border-blue-500/30 bg-blue-500/10 text-white font-semibold transition-all duration-500 hover:bg-blue-500 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]"
                  >

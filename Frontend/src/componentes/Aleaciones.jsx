    ...
    <section className="w-full overflow-hidden bg-[#020817] bg-[radial-gradient(circle_at_top,rgba(37,99,235,0.12),transparent_35%)] text-white py-16 sm:py-20 px-4 sm:px-6 md:px-10 lg:px-16 relative">
        ...
        >
          {aleaciones.map((item, index) => (
            <motion.div
              ...
              variants={fadeUp}
              transition={{ duration: 0.6, ease: "easeOut" }}
              className="group relative bg-[#081120] rounded-3xl overflow-hidden border border-blue-500/10 hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_45px_rgba(37,99,235,0.18)]"
            >
              ...
              <div className="relative p-7">
                ...
                <button className="w-full py-3 rounded-xl border border-blue-500/30 bg-blue-500/10 text-white font-semibold transition-all duration-500 hover:bg-blue-500 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]">
      ...
      >
        <div className="bg-gradient-to-r from-[#0F172A] to-[#111827] border border-blue-500/20 rounded-3xl p-6 sm:p-8 md:p-10 text-center shadow-[0_0_50px_rgba(37,99,235,0.10)]">
          ...
          <button className="px-6 sm:px-8 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 transition-all duration-500 font-semibold shadow-[0_0_20px_rgba(37,99,235,0.30)]">

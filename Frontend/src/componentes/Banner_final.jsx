      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        ">
          ...
          >
            ...
            <div className="mt-5 space-y-4 text-sm text-gray-300 max-md:items-center max-md:flex max-md:flex-col">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
          className="
            border-t border-gray-800/50 py-6
        ...
        <div className="text-center text-xs text-gray-500 mt-6 pb-4">
          Powered by{" "}
          <a
            href="https://www.instagram.com/cordilleratechoficial/"
            target="_blank"

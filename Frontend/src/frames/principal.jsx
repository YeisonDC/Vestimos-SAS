        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-5">
          ...
          >
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-5 max-w-md pr-10 font-medium">
              Somos una comercializadora internacional especializada en la importación y exportación de productos de alta calidad. Conectamos oportunidades,
              generamos valor y llevamos lo mejor de colombia a tu empresa.
            </p>
      ...
      >
        <div className="bg-[#0A111E] border border-gray-800/80 rounded-xl flex flex-wrap lg:flex-nowrap items-center justify-between p-6 shadow-2xl shadow-black/50 divide-x divide-gray-800/60">
          ...
          {[
            ...
            { icon: <Handshake />, title: '500+', text: 'Clientes\nsatisfechos' },
            { icon: <Package />, title: '1000+', text: 'Operaciones\nexitosas' },
            { icon: <ShieldCheck />, title: '15+', text: 'Años de experiencia\nen el mercado' },
            { icon: <Users />, title: 'Equipo experto', text: 'Comprometidos con\ntu crecimiento' }
          ].map((item, index) => (
            <motion.div
              key={index}
